...
public final class RadarPanel {
    ...
    public static void build(VehicleState state, @NotNull Map<String, ModelComponent> hudComponents, Vector3f hudCenter) {
        ...
        addOctagon(hudComponents, "outer-octagon", center, rotation, Material.GRAY_STAINED_GLASS, 0.3, 0.09);
        addOctagon(hudComponents, "middle-octagon", center, rotation, Material.GREEN_STAINED_GLASS, 0.2, 0.06);
        addOctagon(hudComponents, "inner-octagon", center, rotation, Material.LIME_STAINED_GLASS, 0.1, 0.03);
    }
}
