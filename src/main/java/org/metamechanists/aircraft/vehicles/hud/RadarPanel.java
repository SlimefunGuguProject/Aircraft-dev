...
public final class RadarPanel {
    ...
    public static void build(VehicleState state, @NotNull Map<String, ModelComponent> hudComponents, Vector3f hudCenter) {
        ...
        addOctagon(state, hudComponents, "outer-octagon", center, rotation, Material.GRAY_STAINED_GLASS, 0.3, 0.03);
        addOctagon(state, hudComponents, "middle-octagon", center, rotation, Material.GREEN_STAINED_GLASS, 0.2, 0.02);
        addOctagon(state, hudComponents, "inner-octagon", center, rotation, Material.LIME_STAINED_GLASS, 0.1, 0.01);
    }
}
