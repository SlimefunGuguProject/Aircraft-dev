...
public class AircraftSurface {
    private static final double AIR_DENSITY = 1;
    ...
    public SpatialForce getDragForce(final @NotNull Vector3d aircraftRotation, final @NotNull Vector3d aircraftVelocity) {
        ...
        final Vector3d force = dragDirection.mul(dragDirection.dot(airflowVelocity) * 0.5 * dragCoefficient * AIR_DENSITY * getRelativeArea(airflowVelocity) * aircraftSpeed * aircraftSpeed);
    ...
    public SpatialForce getLiftForce(final @NotNull Vector3d aircraftRotation, final @NotNull Vector3d aircraftVelocity) {
        ...
        final Vector3d force = liftDirection.mul(liftDirection.dot(airflowVelocity) * 0.5 * liftCoefficient * AIR_DENSITY * getRelativeArea(airflowVelocity) * aircraftSpeed * aircraftSpeed);
