...
public class Utils {
    ...
    public Vector3d rotate(final @NotNull Vector3d vector, final @NotNull Vector3d rotation) {
        ...
        return new Vector3d(vector).rotate(new Quaterniond().rotateXYZ(rotation.x, rotation.y, rotation.z));
    ...
    public Vector3f rotate(final @NotNull Vector3f vector, final @NotNull Vector3d rotation) {
        ...
        return new Vector3f(vector).rotate(new Quaternionf().rotateXYZ((float) rotation.x, (float) rotation.y, (float) rotation.z));
